...
public class EmployeeStreamTest {
     ...
     *
     * Collectors.toList()
     * -> 모든 Stream의 요소를 List 인스턴스로 수집하는데 사용할 수 있음.
    ...
    void group_employees_by_city() {
        System.out.println("group_employees_by_city");
    ...
    void group_employees_by_city_and_get_employee_name() {
        System.out.println("group_employees_by_city_and_get_employee_name");
    ...
    void group_employees_by_age() {
        System.out.println("group_employees_by_age");
